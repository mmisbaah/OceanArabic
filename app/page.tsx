...
export default function Home() {
  ...
  return <main className={`app-shell page-${active.toLowerCase()}`}>
    <header className="topbar">
      <div className="header-left"><img className="deck-mascot" src="/assets/nooru.png" onError={imageFallback("/assets/avatars/avatar-01.png")} alt="Nooru mascot"/><div className="avatar"><img src={learner.avatar} onError={imageFallback("/assets/avatars/avatar-01.png")} alt={`${learner.name} avatar`}/></div><div className="learner-label"><b>Hello, {learner.name}</b><small>G{learner.grade} · {learner.difficulty}</small></div></div>
